function openModal(req, passed, datepassed, verified, dateverified){
    ...
    document.querySelector('#req_passed').innerText = passed;
...
document.querySelector('#editreq_btn').addEventListener('click', (e) => {
    ...
    xhr.open("POST", "roomeditreq_stud.php", true); 
    ...
    var data = {
        ...
        passed: document.querySelector('#req_passedd').value,
        datepassed: document.querySelector('#req_datepassed').value,
        verified: document.querySelector('#req_verified').value,
